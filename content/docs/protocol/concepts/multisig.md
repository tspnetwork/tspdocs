...
A **multisig account** is an TSP account with a special key that can require more than one signature to sign transactions.
...
```
tspd keys add --multisig=p1,p2,p3 --multisig-threshold=2 multisig_address
tspd keys add --multisig=p2,p3,p1 --multisig-threshold=2 multisig_address
```
...
```
tspd keys add --multisig=p1,p2,p3 --multisig-threshold=2 multisig_addresstspd keys add --multisig=p2,p3,p1 --multisig-threshold=2 multisig_address
```

Multisig addresses can also be generated on-the-fly and printed through the which command:

```
tspd keys show --multisig-threshold=K name1 name2 name3 [...]
```
...
tspd keys add \
    test3 \
    --pubkey=tsppub1addwnpepqgcxazmq6wgt2j4rdfumsfwla0zfk8e5sws3p3zg5dkm9007hmfysxas0u2
```
...
```
tspd keys show multi

- name: multi
  type: multi
  address: tsp1e0fx0q9meawrcq7fmma9x60gk35lpr4xk3884m
  pubkey: tsppub1ytql0csgqgfzd666axrjzq3mxw59ys6yqcd3ydjvhgs0uzs6kdk5fp4t73gmkl8t6y02yfq7tvfzd666axrjzq3sd69kp5usk492x6nehqjal67ynv0nfqapzrzy3gmdk27la0kjfqfzd666axrjzq6utqt639ka2j3xkncgk65dup06t297ccljmxhvhu3rmk92u3afjuyz9dg9
  mnemonic: ""
  threshold: 0
  pubkeys: []
```

Let's add 10 TSP to the multisig wallet:

```
tspd tx bank send \
    test1 \
    tsp1e0fx0q9meawrcq7fmma9x60gk35lpr4xk3884m \
    10000000000000000000tsp \
    --chain-id=tsp_9000-4 \
    --gas=auto \
    --fees=1000000tsp \
...
We want to send 5 TSP from our multisig account to `tsp1rgjxswhuxhcrhmyxlval0qa70vxwvqn2e0srft`.

```
tspd tx bank send \
    tsp1rgjxswhuxhcrhmyxlval0qa70vxwvqn2e0srft \
    tsp157g6rn6t6k5rl0dl57zha2wx72t633axqyvvwq \
    5000000000000000000tsp \
    --gas=200000 \
    --fees=1000000tsp \
    --chain-id=tsp_9000-4 \
    ...
    "messages": [
      {
        ...
        "from_address": "tsp1rgjxswhuxhcrhmyxlval0qa70vxwvqn2e0srft",
        "to_address": "tsp157g6rn6t6k5rl0dl57zha2wx72t633axqyvvwq",
        "amount": [
          {
            "denom": "tsp",
...
tspd tx sign \
    unsignedTx.json \
    --multisig=tsp1e0fx0q9meawrcq7fmma9x60gk35lpr4xk3884m \
    --from=test1 \
...
```
tspd tx broadcast signedTx.json \
    --chain-id=tsp_9000-4 \
    --broadcast-mode=block
```