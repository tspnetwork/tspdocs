...
Find below a list of JSON-RPC methods supported on TSP, sorted by namespaces.
...
| --- | --- | --- | --- | --- |
| [`web3_clientVersion`](/docs/develop/api/ethereum-json-rpc/methods#web3_clientversion) | Web3 | ✔   | ✔   |     |
| [`web3_sha3`](/docs/develop/api/ethereum-json-rpc/methods#web3_sha3) | Web3 | ✔   | ✔   |     |
| [`net_version`](/docs/develop/api/ethereum-json-rpc/methods#net_version) | Net | ✔   | ✔   |     |
| [`net_peerCount`](/docs/develop/api/ethereum-json-rpc/methods#net_peerCount) | Net | ✔   | ✔   |     |
| [`net_listening`](/docs/develop/api/ethereum-json-rpc/methods#net_listening) | Net | ✔   | ✔   |     |
| [`eth_protocolVersion`](/docs/develop/api/ethereum-json-rpc/methods#eth_protocolversion) | Eth | ✔   | ✔   |     |
| [`eth_syncing`](/docs/develop/api/ethereum-json-rpc/methods#eth_syncing) | Eth | ✔   | ✔   |     |
| [`eth_gasPrice`](/docs/develop/api/ethereum-json-rpc/methods#eth_gasprice) | Eth | ✔   | ✔   |     |
| [`eth_accounts`](/docs/develop/api/ethereum-json-rpc/methods#eth_accounts) | Eth | ✔   | ✔   |     |
| [`eth_blockNumber`](/docs/develop/api/ethereum-json-rpc/methods#eth_blocknumber) | Eth | ✔   | ✔   |     |
| [`eth_getBalance`](/docs/develop/api/ethereum-json-rpc/methods#eth_getbalance) | Eth | ✔   | ✔   |     |
| [`eth_getStorageAt`](/docs/develop/api/ethereum-json-rpc/methods#eth_getstorageat) | Eth | ✔   | ✔   |     |
| [`eth_getTransactionCount`](/docs/develop/api/ethereum-json-rpc/methods#eth_gettransactioncount) | Eth | ✔   | ✔   |     |
| [`eth_getBlockTransactionCountByNumber`](/docs/develop/api/ethereum-json-rpc/methods#eth_getblocktransactioncountbynumber) | Eth | ✔   | ✔   |     |
| [`eth_getBlockTransactionCountByHash`](/docs/develop/api/ethereum-json-rpc/methods#eth_getblocktransactioncountbyhash) | Eth | ✔   | ✔   |     |
| [`eth_getCode`](/docs/develop/api/ethereum-json-rpc/methods#eth_getcode) | Eth | ✔   | ✔   |     |
| [`eth_sign`](/docs/develop/api/ethereum-json-rpc/methods#eth_sign) | Eth | ✔   | ✔   |     |
| [`eth_sendTransaction`](/docs/develop/api/ethereum-json-rpc/methods#eth_sendtransaction) | Eth | ✔   | ✔   |     |
| [`eth_sendRawTransaction`](/docs/develop/api/ethereum-json-rpc/methods#eth_sendrawtransaction) | Eth | ✔   | ✔   |     |
| [`eth_call`](/docs/develop/api/ethereum-json-rpc/methods#eth_call) | Eth | ✔   | ✔   |     |
| [`eth_estimateGas`](/docs/develop/api/ethereum-json-rpc/methods#eth_estimategas) | Eth | ✔   | ✔   |     |
| [`eth_getBlockByNumber`](/docs/develop/api/ethereum-json-rpc/methods#eth_getblockbynumber) | Eth | ✔   | ✔   |     |
| [`eth_getBlockByHash`](/docs/develop/api/ethereum-json-rpc/methods#eth_getblockbyhash) | Eth | ✔   | ✔   |     |
| [`eth_getTransactionByHash`](/docs/develop/api/ethereum-json-rpc/methods#eth_gettransactionbyhash) | Eth | ✔   | ✔   |     |
| [`eth_getTransactionByBlockHashAndIndex`](/docs/develop/api/ethereum-json-rpc/methods#eth_gettransactionbyblockhashandindex) | Eth | ✔   | ✔   |     |
| [`eth_getTransactionReceipt`](/docs/develop/api/ethereum-json-rpc/methods#eth_gettransactionreceipt) | Eth | ✔   | ✔   |     |
| [`eth_newFilter`](/docs/develop/api/ethereum-json-rpc/methods#eth_newfilter) | Eth | ✔   | ✔   |     |
| [`eth_newBlockFilter`](/docs/develop/api/ethereum-json-rpc/methods#eth_newblockfilter) | Eth | ✔   | ✔   |     |
| [`eth_newPendingTransactionFilter`](/docs/develop/api/ethereum-json-rpc/methods#eth_newpendingtransactionfilter) | Eth | ✔   | ✔   |     |
| [`eth_uninstallFilter`](/docs/develop/api/ethereum-json-rpc/methods#eth_uninstallfilter) | Eth | ✔   | ✔   |     |
| [`eth_getFilterChanges`](/docs/develop/api/ethereum-json-rpc/methods#eth_getfilterchanges) | Eth | ✔   | ✔   |     |
| [`eth_getFilterLogs`](/docs/develop/api/ethereum-json-rpc/methods#eth_getfilterlogs) | Eth | ✔   | ✔   |     |
| [`eth_getLogs`](/docs/develop/api/ethereum-json-rpc/methods#eth_getlogs) | Eth | ✔   | ✔   |     |
...
| `eth_mining` | Eth |     | ❌   |     |
| [`eth_coinbase`](/docs/develop/api/ethereum-json-rpc/methods#eth_coinbase) | Eth | ✔   |     |     |
...
| [`eth_getProof`](/docs/develop/api/ethereum-json-rpc/methods#eth_getProof) | Eth | ✔   |     |     |
| [`eth_subscribe`](/docs/develop/api/ethereum-json-rpc/methods#eth_subscribe) | Websocket | ✔   |     |     |
| [`eth_unsubscribe`](/docs/develop/api/ethereum-json-rpc/methods#eth_unsubscribe) | Websocket | ✔   |     |     |
| [`personal_importRawKey`](/docs/develop/api/ethereum-json-rpc/methods#personal-importrawkey) | Personal | ✔   | ❌   |     |
| [`personal_listAccounts`](/docs/develop/api/ethereum-json-rpc/methods#personal-listaccounts) | Personal | ✔   | ❌   |     |
| [`personal_lockAccount`](/docs/develop/api/ethereum-json-rpc/methods#personal-lockaccount) | Personal | ✔   | ❌   |     |
| [`personal_newAccount`](/docs/develop/api/ethereum-json-rpc/methods#personal-newaccount) | Personal | ✔   | ❌   |     |
| [`personal_unlockAccount`](/docs/develop/api/ethereum-json-rpc/methods#personal-unlockaccount) | Personal | ✔   | ❌   |     |
| [`personal_sendTransaction`](/docs/develop/api/ethereum-json-rpc/methods#personal-sendtransaction) | Personal | ✔   | ❌   |     |
| [`personal_sign`](/docs/develop/api/ethereum-json-rpc/methods#personal-sign) | Personal | ✔   | ❌   |     |
| [`personal_ecRecover`](/docs/develop/api/ethereum-json-rpc/methods#personal-ecrecover) | Personal | ✔   | ❌   |     |
| [`personal_initializeWallet`](/docs/develop/api/ethereum-json-rpc/methods#personal_initializewallet) | Personal | ✔   | ❌   |     |
| [`personal_unpair`](/docs/develop/api/ethereum-json-rpc/methods#personal_unpair) | Personal | ✔   | ❌   |     |
| `db_putString` | DB  |     |     |     |
| `db_getString` | DB  |     |     |     |
| `db_putHex` | DB  |     |     |     |
| `db_getHex` | DB  |     |     |     |
...
| [`debug_traceBlock`](/docs/develop/api/ethereum-json-rpc/methods#debug-traceblock) | Debug | ✔   |     |     |
| [`debug_traceBlockByNumber`](/docs/develop/api/ethereum-json-rpc/methods#debug-traceblockbynumber) | Debug | ✔   |     |     |
| [`debug_traceBlockByHash`](/docs/develop/api/ethereum-json-rpc/methods#debug-traceblockbyhash) | Debug | ✔   |     |     |
| `debug_traceBlockFromFile` | Debug |     |     |     |
| `debug_standardTraceBlockToFile` | Debug |     |     |     |
| `debug_standardTraceBadBlockToFile` | Debug |     |     |     |
| [`debug_traceTransaction`](/docs/develop/api/ethereum-json-rpc/methods#debug-tracetransaction) | Debug | ✔   |     |     |
...
| [`miner_getHashrate`](/docs/develop/api/ethereum-json-rpc/methods#miner-gethashrate) | Miner | ✔   | ❌   | No-op |
| [`miner_setExtra`](/docs/develop/api/ethereum-json-rpc/methods#miner-setextra) | Miner | ✔   | ❌   | No-op |
| [`miner_setGasPrice`](/docs/develop/api/ethereum-json-rpc/methods#miner-setgasprice) | Miner | ✔   | ❌   | Needs node restart |
| [`miner_start`](/docs/develop/api/ethereum-json-rpc/methods#miner-start) | Miner | ✔   | ❌   | No-op |
| [`miner_stop`](/docs/develop/api/ethereum-json-rpc/methods#miner-stop) | Miner | ✔   | ❌   | No-op |
| [`miner_setGasLimit`](/docs/develop/api/ethereum-json-rpc/methods#miner-setgaslimit) | Miner | ✔   | ❌   | No-op |
| [`miner_setEtherbase`](/docs/develop/api/ethereum-json-rpc/methods#miner-setetherbase) | Miner | ✔   | ❌   |     |
| [`txpool_content`](/docs/develop/api/ethereum-json-rpc/methods#txpool-content) | TxPool | ✔   |     |     |
| [`txpool_inspect`](/docs/develop/api/ethereum-json-rpc/methods#txpool-inspect) | TxPool | ✔   |     |     |
| [`txpool_status`](/docs/develop/api/ethereum-json-rpc/methods#txpool-status) | TxPool | ✔   |     |     |
...
```
 {"jsonrpc":"2.0","id":1,"result":"TSP/0.1.3+/linux/go1.18"}
```
...
You can get signed transaction data using the [`personal_sign`](/docs/develop/api/ethereum-json-rpc/methods#personal-sign) method.
...
- Object containing:
  ...
  `blockhash`: (optional, future) With the addition of [EIP-234](https://eips.ethereum.org/EIPS/eip-234), `blockHash` will be a new filter option which restricts the logs returned to the single block with the
  32-byte hash `blockHash`. Using `blockHash` is equivalent to `fromBlock` = `toBlock` = the block number
  with hash `blockHash`. If `blockHash` is present in in the filter criteria, then neither `fromBlock` nor `toBlock` are allowed.
...
Read about websockets in [Tendermint Events](/docs/develop/api/tendermint-rpc)
...
The account can be used with [`eth_sign`](/docs/develop/api/ethereum-json-rpc/methods#eth_sign) and [`eth_sendTransaction`](/docs/develop/api/ethereum-json-rpc/methods#eth_sendtransaction) while it is unlocked.
...
The transaction is the same argument as for [`eth_sendTransaction`](/docs/develop/api/ethereum-json-rpc/methods#eth_sendtransaction) and contains the `from` address. If the passphrase can be used to decrypt the private key belonging to `tx.from` the transaction is verified, signed and send onto the network.
...
`ecRecover` returns the address associated with the private key that was used to calculate the signature in [`personal_sign`](/docs/develop/api/ethereum-json-rpc/methods#personal-sign).

#### Parameters

- Message
  
- Signature returned from [`personal_sign`](/docs/develop/api/ethereum-json-rpc/methods#personal-sign)
...
Make sure your `tspd start` call is not using the flag `minimum-gas-prices`,
